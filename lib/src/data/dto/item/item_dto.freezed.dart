...
@JsonKey(name: 'AlbumId') String? get albumId;@JsonKey(name: 'AlbumPrimaryImageTag') String? get albumPrimaryImageTag;@JsonKey(name: 'Album') String? get albumName;@JsonKey(name: 'AlbumArtist') String? get albumArtist;@JsonKey(name: 'AlbumArtists') List<ArtistDTO> get albumArtists;@JsonKey(name: 'Genres') List<String> get genres;@JsonKey(name: 'BackdropImageTags') List<String> get backdropImageTags;@JsonKey(name: 'ImageTags') Map<String, String> get imageTags;@JsonKey(name: 'PrimaryImageTag') String? get primaryImageTag;@JsonKey(name: 'PrimaryImageItemId') String? get primaryImageItemId;@JsonKey(name: 'HasLyrics') bool get hasLyrics;@JsonKey(name: 'UserData') UserData get userData;@JsonKey(name: 'MediaSources') List<MediaSourceDTO> get mediaSources;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,type,indexNumber,runTimeTicks,path,collectionType,playlistItemId,overview,productionYear,albumId,albumPrimaryImageTag,albumName,albumArtist,const DeepCollectionEquality().hash(albumArtists),const DeepCollectionEquality().hash(genres),const DeepCollectionEquality().hash(backdropImageTags),const DeepCollectionEquality().hash(imageTags),primaryImageTag,primaryImageItemId,hasLyrics,userData,const DeepCollectionEquality().hash(mediaSources)]);

@override
String toString() {
  return 'ItemDTO(id: $id, name: $name, type: $type, indexNumber: $indexNumber, runTimeTicks: $runTimeTicks, path: $path, collectionType: $collectionType, playlistItemId: $playlistItemId, overview: $overview, productionYear: $productionYear, albumId: $albumId, albumPrimaryImageTag: $albumPrimaryImageTag, albumName: $albumName, albumArtist: $albumArtist, albumArtists: $albumArtists, genres: $genres, backdropImageTags: $backdropImageTags, imageTags: $imageTags, primaryImageTag: $primaryImageTag, primaryImageItemId: $primaryImageItemId, hasLyrics: $hasLyrics, userData: $userData, mediaSources: $mediaSources)';
}
...
switch (_that) {
case _ItemDTO() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.indexNumber,_that.runTimeTicks,_that.path,_that.collectionType,_that.playlistItemId,_that.overview,_that.productionYear,_that.albumId,_that.albumPrimaryImageTag,_that.albumName,_that.albumArtist,_that.albumArtists,_that.genres,_that.backdropImageTags,_that.imageTags,_that.primaryImageTag,_that.primaryImageItemId,_that.hasLyrics,_that.userData,_that.mediaSources);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,type,indexNumber,runTimeTicks,path,collectionType,playlistItemId,overview,productionYear,albumId,albumPrimaryImageTag,albumName,albumArtist,const DeepCollectionEquality().hash(_albumArtists),const DeepCollectionEquality().hash(_genres),const DeepCollectionEquality().hash(_backdropImageTags),const DeepCollectionEquality().hash(_imageTags),primaryImageTag,primaryImageItemId,hasLyrics,userData,const DeepCollectionEquality().hash(_mediaSources)]);
