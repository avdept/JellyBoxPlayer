...
@freezed
abstract class AlbumsWrapper with _$AlbumsWrapper {
  const factory AlbumsWrapper({
    @JsonKey(name: 'Items') required List<ItemDTO> items,
    @JsonKey(name: 'TotalRecordCount') required int totalRecordCount,
  }) = _AlbumsWrapper;

  factory AlbumsWrapper.fromJson(Map<String, dynamic> json) =>
      _$AlbumsWrapperFromJson(json);
}
