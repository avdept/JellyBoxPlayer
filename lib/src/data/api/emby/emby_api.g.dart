...
class _EmbyApi implements EmbyApi {
  _EmbyApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<String>> getSubtitleTrack({
    ...
    final _options = _setStreamType<HttpResponse<String>>(
      Options(
          ...
          .compose(
            _dio.options,
            '/Items/${itemId}/${mediaSourceId}/Subtitles/${index}/Stream.js',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<HttpResponse<void>> createPlaylist({
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'MediaType': mediaType};
    final _headers = <String, dynamic>{};
    final _data = values;
    final _options = _setStreamType<HttpResponse<void>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
