...
class CloudDevicesSheet extends ConsumerWidget {
  const CloudDevicesSheet({super.key});

  static Future<void> show(BuildContext context) => showModalBottomSheet<void>(
    context: context,
    showDragHandle: true,
    builder: (_) => const CloudDevicesSheet(),
  );
  ...
  String _statusLine(CloudState state) => switch (state.status) {
...
class _DeviceTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return ListTile(
      leading: Icon(conductorDeviceIcon(device.platform)),
