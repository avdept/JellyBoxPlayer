...
as List<AudioSourceInfo>,externalIds: null == externalIds ? _self.externalIds : externalIds // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() List<AudioSourceInfo> get audioSources {
 ...
 final  Map<String, String> _externalIds;
@override@JsonKey() Map<String, String> get externalIds {
...
as List<AudioSourceInfo>,externalIds: null == externalIds ? _self._externalIds : externalIds // ignore: cast_nullable_to_non_nullable
as Map<String, String>,
  ));
}
